...
class Action(Enum):
    ...
    DEAD_UP_FALL_ICE = 0x9
    DEAD_UP_FALL_HIT_CAMERA_ICE = 0xa
    SLEEP = 0xb
    ON_HALO_DESCENT = 0xc
    ON_HALO_WAIT = 0x0d
    STANDING = 0x0e
    ...
    PARASOL_SWING3 = 0x81
    PARASOL_SWING4 = 0x82
    PARASOL_SWING_DASH = 0x83
    HARISEN_SWING1 = 0x84
    HARISEN_SWING3 = 0x85
    HARISEN_SWING4 = 0x86
    HARISEN_SWING_DASH = 0x87
    STAR_ROD_SWING1 = 0x88
    STAR_ROD_SWING3 = 0x89
    STAR_ROD_SWING4 = 0x8a
    STAR_ROD_SWING_DASH = 0x8b
    LIP_STICK_SWING1 = 0x8c
    LIP_STICK_SWING3 = 0x8d
    LIP_STICK_SWING4 = 0x8e
    LIP_STICK_SWING_DASH = 0x8f
    ITEM_PARASOL_OPEN = 0x90
    ITEM_PARASOL_FALL = 0x91
    ITEM_PARASOL_FALL_SPECIAL = 0x92
    ITEM_PARASOL_DAMAGE_FALL = 0x93
    L_GUN_SHOOT = 0x94
    L_GUN_SHOOT_AIR = 0x95
    L_GUN_SHOOT_EMPTY = 0x96
    L_GUN_SHOOT_AIR_EMPTY = 0x97
    ...
    CAPTUREDAMAGE_MASTERHAND = 0x148
    CAPTUREWAIT_MASTERHAND = 0x149
    THROWN_MASTERHAND = 0x14a
    CAPTURE_KIRBY_YOSHI = 0x14b
    KIRBY_YOSHI_EGG = 0x14c
    CAPTURE_LEADEAD = 0x14d
    CAPTURE_LIKELIKE = 0x14e
    DOWN_REFLECT = 0x14f
    CAPTURE_CRAZYHAND = 0x150
    CAPTUREDAMAGE_CRAZYHAND = 0x151
    CAPTUREWAIT_CRAZYHAND = 0x152
    THROWN_CRAZYHAND = 0x153
    ...
    DOWN_B_GROUND_START = 0x168  # Also known as SWORD_DANCE_2_MID_AIR.
    DOWN_B_GROUND = 0x169  # Also known as SWORD_DANCE_3_HIGH_AIR.
    SWORD_DANCE_3_MID_AIR = 0x16a
    SWORD_DANCE_3_LOW_AIR = 0x16b
    SWORD_DANCE_4_HIGH_AIR = 0x16c
    DOWN_B_STUN = 0x16d  # Also known as SWORD_DANCE_4_MID_AIR.
    DOWN_B_AIR = 0x16e  # Also known as SWORD_DANCE_4_LOW_AIR.
    UP_B_GROUND = 0x16f
